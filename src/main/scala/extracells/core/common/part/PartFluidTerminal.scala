...
import extracells.core.common.container.implementations.ContainerFluidTerminal
...
class PartFluidTerminal extends PartECFluidBase
  ...
  override def renderInventory(rh: IPartRenderHelper, renderer: RenderBlocks): Unit = {
    ...
    val side: IIcon = TextureEnum.TERMINAL_SIDE.getTexture
    rh.setTexture(side)
    rh.setBounds(4, 4, 13, 12, 12, 14)
    rh.renderInventoryBox(renderer)
    rh.setTexture(side, side, side, TextureEnum.BUS_BORDER.getTexture, side, side)
    ...
    rh.renderInventoryFace(TextureEnum.BUS_BORDER.getTexture, ForgeDirection.SOUTH, renderer)

    rh.setBounds(3, 3, 15, 13, 13, 16)
    rh.setInvColor(AEColor.Transparent.blackVariant)
    rh.renderInventoryFace(TextureEnum.TERMINAL_FRONT.getTextures()(0), ForgeDirection.SOUTH, renderer)
    rh.setInvColor(AEColor.Transparent.mediumVariant)
    rh.renderInventoryFace(TextureEnum.TERMINAL_FRONT.getTextures()(1), ForgeDirection.SOUTH, renderer)
    rh.setInvColor(AEColor.Transparent.whiteVariant)
    rh.renderInventoryFace(TextureEnum.TERMINAL_FRONT.getTextures()(2), ForgeDirection.SOUTH, renderer)
  ...
  override def renderStatic(x: Int, y: Int, z: Int, rh: IPartRenderHelper, renderer: RenderBlocks): Unit = {
    ...
    rh.renderFace(x, y, z, TextureEnum.BUS_BORDER.getTexture, ForgeDirection.SOUTH, renderer)

    val host: IPartHost = getHost.get
    rh.setBounds(3, 3, 15, 13, 13, 16)
    ts.setColorOpaque_I(host.getColor.blackVariant)
    rh.renderFace(x, y, z, TextureEnum.TERMINAL_FRONT.getTextures()(0), ForgeDirection.SOUTH, renderer)
    ts.setColorOpaque_I(host.getColor.mediumVariant)
    rh.renderFace(x, y, z, TextureEnum.TERMINAL_FRONT.getTextures()(1), ForgeDirection.SOUTH, renderer)
    ts.setColorOpaque_I(host.getColor.whiteVariant)
    rh.renderFace(x, y, z, TextureEnum.TERMINAL_FRONT.getTextures()(2), ForgeDirection.SOUTH, renderer)
