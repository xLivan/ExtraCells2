package extracells.core.common.grid.inventory
...
import extracells.core.common.util.InventoryUtil
 ...
 */
class FluidCellInventoryHandler(storageStack: ItemStack, val saveProvider: ISaveProvider)
    extends IMEInventoryHandler[IAEFluidStack] with IHandlerFluidStorage {
